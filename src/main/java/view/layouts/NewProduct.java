...
public class NewProduct extends JPanel implements ActionListener{
	...
	public NewProduct() {
		...
		nameLabel.setFont(new Font("Sans Serif", Font.BOLD, 40));
		...
		priceLabel.setFont(new Font("Sans Serif", Font.PLAIN, 25));
		...
		textInputsPanel.add(priceLabel);
                ...
                price.setFont(new Font("Sans Serif", Font.PLAIN, 25));
//                price.setEditable(true);
                textInputsPanel.add(price);
		
		JLabel producentLabel = new JLabel("Producent: ");
		producentLabel.setFont(new Font("Sans Serif", Font.PLAIN, 25));
		producentLabel.setForeground(Color.WHITE);
		textInputsPanel.add(producentLabel);
                
                JTextField producent = new JTextField("Wprowadź nazwę producenta");
                producent.setFont(new Font("Sans Serif", Font.PLAIN, 25));
//                producent.setEditable(isAdmin);
                textInputsPanel.add(producent);

		JLabel categoryLabel = new JLabel("Kategoria: ");
		categoryLabel.setFont(new Font("Sans Serif", Font.PLAIN, 25));
		categoryLabel.setForeground(Color.WHITE);
		textInputsPanel.add(categoryLabel);
                
                JTextField category = new JTextField("Wprowadź nazwę kategorii");
                category.setFont(new Font("Sans Serif", Font.PLAIN, 25));
...
//                descTextArea.setEditable(isAdmin);
	...
	public void actionPerformed(ActionEvent e) {
        ...
        int n = JOptionPane.showOptionDialog(null,
                "Czy chcesz dodać wprowadzony produkt?",
                "",
